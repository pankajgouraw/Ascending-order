    ...
    function loadDynamicData() {
        ...
        $.each(arr, function(index, value) {
            ...
            if (generateHints.includes(value)) {
                let comp = `<li class="" data-ans='${value}' data-user=''><span class='spanHint'>${value}</span></li>`;
                trainContainer += comp;
            } else {
...
optionRandPosition();
    ...
    $('#level4').click(function(){
        playAudio('../audio/beep.mp3');
        window.location.href='../4/main.html';
    })
